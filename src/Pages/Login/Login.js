        ...
        <div className="row align-items-center">
          <div className="col-12 col-md-12 p-3">
            <form className="w-25 mx-auto" onSubmit={handleSubmit(onSubmit)}>
              ...
              <input className="w-100 bg-dark border-0 p-2" type="submit" value="Login" /><br />
            ...
            <div className="w-75 mx-auto text-center pt-3">
              ...
              <Button className="text-center mx-1 bg-warning" onClick={handleGoogleLog}><i className="fab fa-google"></i> Google login</Button>
